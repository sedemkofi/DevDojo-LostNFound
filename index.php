    ...
    <div class="content">
        <div class="header">
            <div class="user-actions">
                ...
                <button class="user-actions-btn user-actions-login" id="login-button">Log in</button>
                <button class="user-actions-btn user-actions-signup" id="signup-button">Sign Up</button>
...
<script>
    const signupButton = document.querySelector('#signup-button');  //selecting signup button element
    ...
    //function to scroll featured items
